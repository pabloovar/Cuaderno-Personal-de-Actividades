...
begin
   ...
   begin
  memo2.lines.add('Primeras tres cisteínas');
  memo2.lines.add('RESIDUOS');
   memo2.lines.add('');
...
begin
  ...
  for m:=1 to 6 do
   ...
   memo2.lines.add('');
   memo2.lines.add('RMSD entre CYS1 y CYS2:  ' + formatfloat('0.0000', RMSD_12));
   memo2.lines.add('RMSD entre CYS1 y CYS3:  ' + formatfloat('0.0000', RMSD_13));
   memo2.lines.add('RMSD entre CYS2 y CYS3:  ' + formatfloat('0.0000', RMSD_23));
